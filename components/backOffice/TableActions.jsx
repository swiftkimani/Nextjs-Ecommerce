...
export default function TableActions({ summary, storefrontHref = "/" }) {
  return (
    <div className="mt-5 flex flex-col gap-4 rounded-[1.75rem] border border-stone-200/80 bg-white/90 p-5 shadow-[0_18px_60px_-46px_rgba(28,25,23,0.45)] lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-wrap gap-3">
        <span className="inline-flex items-center gap-2 rounded-full bg-stone-100 px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-stone-700">
