...
export default function SignInPage() {
  ...
  return (
    <div className="bg-white text-gray-900 font-bodyFont w-full h-screen flex items-center justify-center">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {errEmail && (
                    <p className="text-sm text-red-500 font-titleFont font-semibold px-4">
                      <span className="font-bold italic mr-1">!</span>{errEmail}
                    </p>
                  )}
                </div>
                <div className="flex flex-col gap-1">
                  ...
                  {errPassword && (
                    <p className="text-sm text-red-500 font-titleFont font-semibold px-4">
                      <span className="font-bold italic mr-1">!</span>{errPassword}
                    </p>
                  )}
                </div>
                <button
